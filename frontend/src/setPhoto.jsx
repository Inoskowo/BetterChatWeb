  ...
  import { storage, ref, uploadBytes, getDownloadURL } from "./firebaseConfig.js"; // Importa lo necesario para Firebase Storage
  import { db, auth } from "./firebaseConfig.js"; // Asegúrate de que tienes db y auth importados
